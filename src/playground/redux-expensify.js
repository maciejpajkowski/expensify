...
// SET_END_DATE
const setEndDate = (endDate) => ({ // if there's no default, it is automatically undefined
	type: 'SET_END_DATE',
	endDate
});
...
// January 1st 1970 (unix epoch, starting point for timestamps)
